...
begin
  insert into public.clients (
    ...
    (
      ...
      'Client A',
      'Portal Client A',
      'portal-schema-readiness-client-a@example.test',
      '555-4101',
      'active',
      'Client',
      'Portal Tester A',
      'Disposable portal mapping client A.',
      '2a000000-0000-4000-8000-000000000001'
    )
  ...
  insert into public.clients (
    ...
    (
      ...
      'Client B',
      'Portal Client B',
      'portal-schema-readiness-client-b@example.test',
      '555-4102',
      'active',
      'Client',
      'Portal Tester B',
      'Disposable portal mapping client B.',
      '2a000000-0000-4000-8000-000000000002'
    )
