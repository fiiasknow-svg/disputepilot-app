...
const CHANNELS = [
  { icon: "GD", name: "General Discussion", members: 1240, desc: "Open conversation for all DisputePilot users" },
  { icon: "GS", name: "Getting Started", members: 860, desc: "New to credit repair? Start here" },
  { icon: "MG", name: "Marketing & Growth", members: 742, desc: "Strategies for getting more clients" },
  { icon: "LC", name: "Legal & Compliance", members: 534, desc: "CROA, FCRA, state laws, and more" },
  { icon: "DS", name: "Dispute Strategy", members: 688, desc: "Share dispute tactics and templates" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "240px 1fr", gap: 20 }}>
          <div>
            ...
            <div style={card}>
              ...
              {[
                ["TM", "Total Members", "1,247"],
                ["PW", "Posts This Week", "84"],
                ["ON", "Online Now", "43"],
                ["TC", "Top Contributors", "12"],
              ].map(([icon, label, val]) => (
                  ...
                  <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ display: "flex", gap: 14 }}>
                        <span style={{ fontSize: 12, color: "#94a3b8" }}>Likes: {post.likes}</span>
                        <span style={{ fontSize: 12, color: "#94a3b8" }}>Replies: {post.replies}</span>
                      </div>
                    </div>
                  </div>
                </div>
