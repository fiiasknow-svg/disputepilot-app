...
const routes: RouteSpec[] = [
  {
    ...
    bodyChecks: [
      'All Disputes from the dispute center, with customer lookup, bureau tracking, furnisher context, status workflow, letters, accounts, dates, and action controls.',
      'All Disputes',
      'Disputes',
      'All Statuses',
      'All Bureaus',
