...
const pages = [
  ...
  },
  {
    ...
    buttons: [/ADD NEW EMPLOYEE/i, /TRAINING VIDEOS/i, /Export CSV/i, /Invite by Email/i],
  },
  {
    path: '/bulk-print',
    title: 'Bulk Print',
