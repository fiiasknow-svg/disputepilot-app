...
const navGroups = [
  ...
  },
  {
    ...
    items:[
      ...
      { label:"Attorney Review", href:"/partner-resources/attorney-review", icon:Icons.FileText },
      ...
      <aside className={`cdm-sidebar${mobileSidebarOpen ? " is-open" : ""}`} style={{ width:"280px", backgroundColor:"#1e293b", color:"#94a3b8", display:"flex", flexDirection:"column", position:"fixed", height:"100vh", overflowY:"auto", fontSize:"13px", zIndex:100 }}>
        ...
        <div style={{ padding:"12px 16px", borderBottom:"1px solid #334155" }}>
          ...
          <div style={{ background:"#f59e0b22", borderRadius:6, padding:"6px 10px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            <Link href="/billing" style={{ color:"#f59e0b", fontSize:"11px", fontWeight:600, textDecoration:"none" }}>14 Days Left in The Trial</Link>
